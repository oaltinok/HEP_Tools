...
void Plotter::plotMuon()
{
    plotParticleInfo(rootDir_Muon[branchInd], plotDir_Muon[branchInd]);
}

void Plotter::plotProton()
{    
    plotParticleInfo(rootDir_Proton[branchInd], plotDir_Proton[branchInd]);
}

void Plotter::plotPion()
{
