...
public :
   ...
   //---------------------------------------------------------------------------
    ...
    TH1D* pID_proton_protonScore_LLR;
    TH1D* pID_proton_pionScore_LLR;
    ...
    TH2D* pID_proton_protonScore_protonScore_LLR;
    TH2D* pID_proton_pionScore_pionScore_LLR;
    
    TH1D* pID_piplus_protonScore_LLR;
    TH1D* pID_piplus_pionScore_LLR;
    ...
    TH2D* pID_piplus_protonScore_protonScore_LLR;
    TH2D* pID_piplus_pionScore_pionScore_LLR;
    
    TH1D* pID_piminus_protonScore_LLR;
    TH1D* pID_piminus_pionScore_LLR;
    ...
    TH2D* pID_piminus_protonScore_protonScore_LLR;
    TH2D* pID_piminus_pionScore_pionScore_LLR;
...
//     TH1D* time_UsedClusters;
   ...
   //--------------------------------------------------------------------------
    ...
    std::string failFile[nTopologies];
    std::string cutFile[nTopologies];
    std::string backgroundFile[nTopologies];
