...
void CCProtonPi0_Analyzer::reduce(string playlist)
{
    ...
    string rootDir;
    if (m_isMC) rootDir = Folder_List::rootOut + Folder_List::MC + Folder_List::reduced + "ReducedNTuple_run_v2_27a.root";
    else rootDir = Folder_List::rootOut + Folder_List::Data + Folder_List::reduced + "ReducedNTuple_run_v2_27a.root";
