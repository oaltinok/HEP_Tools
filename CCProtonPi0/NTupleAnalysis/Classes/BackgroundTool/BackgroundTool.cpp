#ifndef BackgroundTool_cpp
#define BackgroundTool_cpp

#include "BackgroundTool.h"

using namespace std;

BackgroundTool::BackgroundTool(int nMode) : NTupleAnalysis(nMode)
{
    cout<<"Initializing BackgroundTool"<<endl;
...
void BackgroundTool::fillBackgroundBranches(    int nProngs,
...
void BackgroundTool::setBackgroundBranch(vector<double>& background, bool hasAntiMuon, bool hasMichel, bool hasPrimaryPi0, bool hasSecondaryPi0 )
{
...
void BackgroundTool::formBackgroundVectors()
{
...
void BackgroundTool::writeBackgroundTableHeader()
{
...
void BackgroundTool::writeBackgroundTableRows(vector< vector<double> > bckgVector, int nProngs)
{
    int t;
    if( nProngs == 1 ) t = 0;
    if( nProngs == 2 ) t = 1;
...
void BackgroundTool::writeBackgroundTable()
{
...
void BackgroundTool::OpenTextFiles()
{
