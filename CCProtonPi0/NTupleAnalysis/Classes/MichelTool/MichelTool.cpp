#ifndef MichelTool_cpp
#define MichelTool_cpp

#include "MichelTool.h"

using namespace std;

MichelTool::MichelTool(int nMode) : NTupleAnalysis(nMode)
{
    cout<<"Initializing MichelTool"<<endl;
...
void MichelTool::initHistograms()
{
...
void MichelTool::write_RootFile()
{
