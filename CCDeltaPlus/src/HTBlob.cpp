...
//=======================================================================
StatusCode HTBlob::getBlobEnergyTime( Minerva::IDBlob *idblob, double &energy ) const
{
    ...
    for ( ; it_clus != idClusters.end(); it_clus++ ){
        ...
        if ( (*it_clus)->subdet() ==  Minerva::IDCluster::ECAL ) energy += (*it_clus)->energy()*m_scalefactor*m_calibrationECal;
        if ( (*it_clus)->subdet() ==  Minerva::IDCluster::HCAL ) energy += (*it_clus)->energy()*m_scalefactor*m_calibrationHCal;
