function [MaRES, DeltaChiSq] = Plot_DeltaChiSq( )
...
plotCustom(MaRES, DeltaChiSq, 'Plots/DeltaChiSq.png', '$$\Delta \chi^2$$');
...
y_3sigma = linspace(9, 9, 1000);
y_5sigma = linspace(25, 25, 1000);
