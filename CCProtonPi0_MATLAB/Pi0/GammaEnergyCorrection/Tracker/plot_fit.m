...
plot(x,y,'LineWidth',3,'DisplayName','Weighted Fit Result');

% Plot Jaewon's Constant
x_j = linspace(0,300,1000);
y_j = linspace(1.326,1.326,1000);
plot(x_j,y_j,'--r','LineWidth',3,'DisplayName','Jaewon''s k_T = 1.326')

% Create xlabel
xlabel('Visible Energy [MeV]','FontSize',48,'FontWeight','bold');
% Create ylabel
ylabel('E_{True}/E_{Visible}','FontSize',48,'FontWeight','bold');
% Create legend
legend(axes1,'show');
...
%% Plot All Region
% Create figure
figure2 = figure('position', [100, 100, 900,900]);
...
plot(x_high,y_high,...
    ...
    'LineWidth',3,...
    'Parent',axes2,...
    'DisplayName','Jaewon''s k_T = 1.326',...
    'Color','r');
