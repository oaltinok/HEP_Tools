...
void DST_CC::run(string playlist, char* filename, string cutFile, string readmeFile)
{
    ...
    fChain->SetBranchStatus("ev_sub_run",1);  // activate
    fChain->SetBranchStatus("ev_gate",1);  // activate

    /* Interaction Info */
    fChain->SetBranchStatus("mc_int_channel",1);  // activate
    fChain->SetBranchStatus("mc_int_current",1);  // activate
    fChain->SetBranchStatus("n_interactions",1);  // activate
    fChain->SetBranchStatus("n_minos_trk",1);  // activate
    fChain->SetBranchStatus("mc_int_nFSParticles",1);  // activate
    fChain->SetBranchStatus("mc_int_QSquared",1);  // Q-Squared of interaction (from event record)
    fChain->SetBranchStatus("mc_int_W",1);  // Hadronic Invariant mass(from event record)

    /* Target Info */
    fChain->SetBranchStatus("mc_int_targetA",1);  // activate
    fChain->SetBranchStatus("mc_int_targetZ",1);  // activate    
    fChain->SetBranchStatus("mc_int_tgtNucleon4p",1);

    /* Incoming Particle Info (Neutrino) */
    fChain->SetBranchStatus("mc_int_incoming4p",1);  // activate

    /* Final State Lepton Info */
    fChain->SetBranchStatus("mc_int_FSLepton4p",1);  // activate

    /* Final State Particles Info */
    fChain->SetBranchStatus("mc_int_FSPdg",1);  // activate
    fChain->SetBranchStatus("mc_int_FSParticlesPx",1);  // activate
    fChain->SetBranchStatus("mc_int_FSParticlesPy",1);  // activate
    fChain->SetBranchStatus("mc_int_FSParticlesPz",1);  // activate
    fChain->SetBranchStatus("mc_int_FSParticlesE",1);  // activate
    ...
    TH1F *energyNeutrino_t0 = new TH1F("energyNeutrino_t0","Incoming Neutrino Energy for 0 Pions",NBINS_energyNeutrino, MIN_energyNeutrino, MAX_energyNeutrino);
    energyNeutrino_t0->GetXaxis()->SetTitle("Neutrino Energy E_{#nu} [GeV]");
    energyNeutrino_t0->GetYaxis()->SetTitle( Form("Candidates / %3.1f ",WIDTH_energyNeutrino) );

    TH1F *energyNeutrino_t1 = new TH1F("energyNeutrino_t1","Incoming Neutrino Energy for 1 Pions",NBINS_energyNeutrino, MIN_energyNeutrino, MAX_energyNeutrino);
    energyNeutrino_t1->GetXaxis()->SetTitle("Neutrino Energy E_{#nu} [GeV]");
    energyNeutrino_t1->GetYaxis()->SetTitle( Form("Candidates / %3.1f ",WIDTH_energyNeutrino) );

    TH1F *energyNeutrino_t2 = new TH1F("energyNeutrino_t2","Incoming Neutrino Energy for 2 Pions",NBINS_energyNeutrino, MIN_energyNeutrino, MAX_energyNeutrino);
    energyNeutrino_t2->GetXaxis()->SetTitle("Neutrino Energy E_{#nu} [GeV]");
    energyNeutrino_t2->GetYaxis()->SetTitle( Form("Candidates / %3.1f ",WIDTH_energyNeutrino) );

    TH1F *energyNeutrino_t3 = new TH1F("energyNeutrino_t3","Incoming Neutrino Energy for 3 Pions",NBINS_energyNeutrino, MIN_energyNeutrino, MAX_energyNeutrino);
    energyNeutrino_t3->GetXaxis()->SetTitle("Neutrino Energy E_{#nu} [GeV]");
    energyNeutrino_t3->GetYaxis()->SetTitle( Form("Candidates / %3.1f ",WIDTH_energyNeutrino) );

    TH1F *energyNeutrino_t4 = new TH1F("energyNeutrino_t4","Incoming Neutrino Energy for 4+ Pions",NBINS_energyNeutrino, MIN_energyNeutrino, MAX_energyNeutrino);
    energyNeutrino_t4->GetXaxis()->SetTitle("Neutrino Energy E_{#nu} [GeV]");
    energyNeutrino_t4->GetYaxis()->SetTitle( Form("Candidates / %3.1f ",WIDTH_energyNeutrino) );


    // Neutrino Energy vs W

    TH2F* Ev_true_w_t0 = new TH2F("Ev_true_w_t0","E_{#nu} True vs W for 0 Pions",NBINS_energyNeutrino, MIN_energyNeutrino, MAX_energyNeutrino, NBINS_W, MIN_W, MAX_W);
    Ev_true_w_t0->GetXaxis()->SetTitle("True Neutrino Energy [GeV]");
    Ev_true_w_t0->GetYaxis()->SetTitle("W [GeV]");

    TH2F* Ev_true_w_t1 = new TH2F("Ev_true_w_t1","E_{#nu} True vs W for 1 Pions",NBINS_energyNeutrino, MIN_energyNeutrino, MAX_energyNeutrino, NBINS_W, MIN_W, MAX_W);
    Ev_true_w_t1->GetXaxis()->SetTitle("True Neutrino Energy [GeV]");
    Ev_true_w_t1->GetYaxis()->SetTitle("W [GeV]");

    TH2F* Ev_true_w_t2 = new TH2F("Ev_true_w_t2","E_{#nu} True vs W for 2 Pions",NBINS_energyNeutrino, MIN_energyNeutrino, MAX_energyNeutrino, NBINS_W, MIN_W, MAX_W);
    Ev_true_w_t2->GetXaxis()->SetTitle("True Neutrino Energy [GeV]");
    Ev_true_w_t2->GetYaxis()->SetTitle("W [GeV]");

    TH2F* Ev_true_w_t3 = new TH2F("Ev_true_w_t3","E_{#nu} True vs W for 3 Pions",NBINS_energyNeutrino, MIN_energyNeutrino, MAX_energyNeutrino, NBINS_W, MIN_W, MAX_W);
    Ev_true_w_t3->GetXaxis()->SetTitle("True Neutrino Energy [GeV]");
    Ev_true_w_t3->GetYaxis()->SetTitle("W [GeV]");

    TH2F* Ev_true_w_t4 = new TH2F("Ev_true_w_t4","E_{#nu} True vs W for 4+ Pions",NBINS_energyNeutrino, MIN_energyNeutrino, MAX_energyNeutrino, NBINS_W, MIN_W, MAX_W);
    Ev_true_w_t4->GetXaxis()->SetTitle("True Neutrino Energy [GeV]");
    Ev_true_w_t4->GetYaxis()->SetTitle("W [GeV]");



    // Neutrino Energy vs Q

    TH2F* Ev_true_q_t0 = new TH2F("Ev_true_q_t0","E_{#nu} True vs Q^2 for 0 Pions",NBINS_energyNeutrino, MIN_energyNeutrino, MAX_energyNeutrino, NBINS_W, MIN_W, MAX_W);
    Ev_true_w_t0->GetXaxis()->SetTitle("True Neutrino Energy [GeV]");
    Ev_true_w_t0->GetYaxis()->SetTitle("Q^2 [GeV]");

    TH2F* Ev_true_q_t1 = new TH2F("Ev_true_q_t1","E_{#nu} True vs Q^2 for 1 Pions",NBINS_energyNeutrino, MIN_energyNeutrino, MAX_energyNeutrino, NBINS_W, MIN_W, MAX_W);
    Ev_true_q_t1->GetXaxis()->SetTitle("True Neutrino Energy [GeV]");
    Ev_true_q_t1->GetYaxis()->SetTitle("Q^2 [GeV]");

    TH2F* Ev_true_q_t2 = new TH2F("Ev_true_q_t2","E_{#nu} True vs Q^2 for 2 Pions",NBINS_energyNeutrino, MIN_energyNeutrino, MAX_energyNeutrino, NBINS_W, MIN_W, MAX_W);
    Ev_true_q_t2->GetXaxis()->SetTitle("True Neutrino Energy [GeV]");
    Ev_true_q_t2->GetYaxis()->SetTitle("Q^2 [GeV]");

    TH2F* Ev_true_q_t3 = new TH2F("Ev_true_q_t3","E_{#nu} True vs Q^2 for 3 Pions",NBINS_energyNeutrino, MIN_energyNeutrino, MAX_energyNeutrino, NBINS_W, MIN_W, MAX_W);
    Ev_true_q_t3->GetXaxis()->SetTitle("True Neutrino Energy [GeV]");
    Ev_true_q_t3->GetYaxis()->SetTitle("Q^2 [GeV]");

    TH2F* Ev_true_q_t4 = new TH2F("Ev_true_q_t4","E_{#nu} True vs Q^2 for 4+ Pions",NBINS_energyNeutrino, MIN_energyNeutrino, MAX_energyNeutrino, NBINS_W, MIN_W, MAX_W);
    Ev_true_q_t4->GetXaxis()->SetTitle("True Neutrino Energy [GeV]");
    Ev_true_q_t4->GetYaxis()->SetTitle("Q^2 [GeV]");
    ...
    for (Long64_t jentry=0; jentry<nentries;jentry++) {
        ...
        if(mc_int_current[0] == 1){
            nChargeCut++; // Count events for cut information
            if(mc_int_FSPdg[0][0] == mu_minus){
                nFSleptonCut++; // Count events for cut information
                if( mc_int_incoming4p[0][3] > minEnergy_Neutrino && 
                    mc_int_incoming4p[0][3] < maxEnergy_Neutrino){
                    ...
                    // Fill Histograms
                    if(nPions == 0){
                        energyNeutrino_t0->Fill(mc_int_incoming4p[0][3]*mev_to_gev);
                        Ev_true_w_t0->Fill(mc_int_incoming4p[0][3]*mev_to_gev,sqrt(mc_int_W[0])*mev_to_gev);
                        Ev_true_q_t0->Fill(mc_int_incoming4p[0][3]*mev_to_gev,mc_int_QSquared[0]*mevSq_to_gevSq);
                        q_w_t0->Fill(mc_int_QSquared[0]*mevSq_to_gevSq,sqrt(mc_int_W[0])*mev_to_gev);
                    }

                    if(nPions == 1){
                        energyNeutrino_t1->Fill(mc_int_incoming4p[0][3]*mev_to_gev);
                        Ev_true_w_t1->Fill(mc_int_incoming4p[0][3]*mev_to_gev,sqrt(mc_int_W[0])*mev_to_gev);
                        Ev_true_q_t1->Fill(mc_int_incoming4p[0][3]*mev_to_gev,mc_int_QSquared[0]*mevSq_to_gevSq);
                        q_w_t1->Fill(mc_int_QSquared[0]*mevSq_to_gevSq,sqrt(mc_int_W[0])*mev_to_gev);
                    } 

                    if(nPions == 2){
                        energyNeutrino_t2->Fill(mc_int_incoming4p[0][3]*mev_to_gev);
                        Ev_true_w_t2->Fill(mc_int_incoming4p[0][3]*mev_to_gev,sqrt(mc_int_W[0])*mev_to_gev);
                        Ev_true_q_t2->Fill(mc_int_incoming4p[0][3]*mev_to_gev,mc_int_QSquared[0]*mevSq_to_gevSq);
                        q_w_t2->Fill(mc_int_QSquared[0]*mevSq_to_gevSq,sqrt(mc_int_W[0])*mev_to_gev);
                    } 

                    if(nPions == 3){
                        energyNeutrino_t3->Fill(mc_int_incoming4p[0][3]*mev_to_gev);
                        Ev_true_w_t3->Fill(mc_int_incoming4p[0][3]*mev_to_gev,sqrt(mc_int_W[0])*mev_to_gev);
                        Ev_true_q_t3->Fill(mc_int_incoming4p[0][3]*mev_to_gev,mc_int_QSquared[0]*mevSq_to_gevSq);
                        q_w_t3->Fill(mc_int_QSquared[0]*mevSq_to_gevSq,sqrt(mc_int_W[0])*mev_to_gev);
                    } 

                    if(nPions >= 4){
                        energyNeutrino_t4->Fill(mc_int_incoming4p[0][3]*mev_to_gev);
                        Ev_true_w_t4->Fill(mc_int_incoming4p[0][3]*mev_to_gev,sqrt(mc_int_W[0])*mev_to_gev);
                        Ev_true_q_t4->Fill(mc_int_incoming4p[0][3]*mev_to_gev,mc_int_QSquared[0]*mevSq_to_gevSq);
                        q_w_t4->Fill(mc_int_QSquared[0]*mevSq_to_gevSq,sqrt(mc_int_W[0])*mev_to_gev);
                    }  
...
void DST_CC::plotHistograms(char* mcFile, string plotDir)
{
    ...
    // Neutrino Energy
    TH1F* h_mc_energyNeutrino_t0 = f_mc->Get("energyNeutrino_t0");
    TH1F* h_mc_energyNeutrino_t1 = f_mc->Get("energyNeutrino_t1");
    TH1F* h_mc_energyNeutrino_t2 = f_mc->Get("energyNeutrino_t2");
    TH1F* h_mc_energyNeutrino_t3 = f_mc->Get("energyNeutrino_t3");
    TH1F* h_mc_energyNeutrino_t4 = f_mc->Get("energyNeutrino_t4");

    plotSingleHist_1D(h_mc_energyNeutrino_t0,"NeutrinoEnergy_t0.png",plotDir);
    plotSingleHist_1D(h_mc_energyNeutrino_t1,"NeutrinoEnergy_t1.png",plotDir);
    plotSingleHist_1D(h_mc_energyNeutrino_t2,"NeutrinoEnergy_t2.png",plotDir);
    plotSingleHist_1D(h_mc_energyNeutrino_t3,"NeutrinoEnergy_t3.png",plotDir);
    plotSingleHist_1D(h_mc_energyNeutrino_t4,"NeutrinoEnergy_t4.png",plotDir);


//     // Neutrino Energy vs W
//     TH2F* h_Ev_true_w_t0 = f_mc->Get("Ev_true_w_t0");
//     TH2F* h_Ev_true_w_t1 = f_mc->Get("Ev_true_w_t1");
//     TH2F* h_Ev_true_w_t2 = f_mc->Get("Ev_true_w_t2");
//     TH2F* h_Ev_true_w_t3 = f_mc->Get("Ev_true_w_t3");
//     TH2F* h_Ev_true_w_t4 = f_mc->Get("Ev_true_w_t4");
// 
//     plot2DHist(h_Ev_true_w_t0,"Enu_w_t0.png",plotDir);
//     plot2DHist(h_Ev_true_w_t1,"Enu_w_t1.png",plotDir);
//     plot2DHist(h_Ev_true_w_t2,"Enu_w_t2.png",plotDir);
//     plot2DHist(h_Ev_true_w_t3,"Enu_w_t3.png",plotDir);
//     plot2DHist(h_Ev_true_w_t4,"Enu_w_t4.png",plotDir);
// 
// 
//     // Neutrino Energy vs Q^2
//     TH2F* h_Ev_true_q_t0 = f_mc->Get("Ev_true_q_t0");
//     TH2F* h_Ev_true_q_t1 = f_mc->Get("Ev_true_q_t1");
//     TH2F* h_Ev_true_q_t2 = f_mc->Get("Ev_true_q_t2");
//     TH2F* h_Ev_true_q_t3 = f_mc->Get("Ev_true_q_t3");
//     TH2F* h_Ev_true_q_t4 = f_mc->Get("Ev_true_q_t4");
// 
//     plot2DHist(h_Ev_true_q_t0,"Enu_q_t0.png",plotDir);
//     plot2DHist(h_Ev_true_q_t1,"Enu_q_t1.png",plotDir);
//     plot2DHist(h_Ev_true_q_t2,"Enu_q_t2.png",plotDir);
//     plot2DHist(h_Ev_true_q_t3,"Enu_q_t3.png",plotDir);
//     plot2DHist(h_Ev_true_q_t4,"Enu_q_t4.png",plotDir);
// 
// 
//     // Q^2 vs W
//     TH2F* h_q_w_t0 = f_mc->Get("q_w_t0");
//     TH2F* h_q_w_t1 = f_mc->Get("q_w_t1");
//     TH2F* h_q_w_t2 = f_mc->Get("q_w_t2");
//     TH2F* h_q_w_t3 = f_mc->Get("q_w_t3");
//     TH2F* h_q_w_t4 = f_mc->Get("q_w_t4");
// 
//     plot2DHist(h_q_w_t0,"q_w_t0.png",plotDir);
//     plot2DHist(h_q_w_t1,"q_w_t1.png",plotDir);
//     plot2DHist(h_q_w_t2,"q_w_t2.png",plotDir);
//     plot2DHist(h_q_w_t3,"E_w_t3.png",plotDir);
//     plot2DHist(h_q_w_t4,"q_w_t4.png",plotDir);


}

void DST_CC::plotSingleHist_1D(TH1F* singleHist, string fileName, string plotDir)
{
...
void DST_CC::plot2DHist(TH2F* hist2D, string fileName, string plotDir)
{
    TCanvas* c1 = new TCanvas();
    hist2D->Draw("contz");
    c1->Print(Form("%s/%s",plotDir.c_str(),fileName.c_str()),"png");
...
void DST_CC::writeResults(ofstream& file)
{
...
int DST_CC::countParticles(int particlePDG)
{
    int nParticles;
    nParticles = 0;

    for(int i = 0; i < mc_int_nFSParticles[0]; i++){
        if(  mc_int_FSPdg[0][i] == particlePDG ){
             nParticles++;
        }
    }
...
int DST_CC::countPions()
{
    int nPions;
    nPions = 0;

    for(int i = 0; i < mc_int_nFSParticles[0]; i++){
        if( isPion( mc_int_FSPdg[0][i] ) ){
             nPions++;
        }
    }
...
bool DST_CC::isPion(int particlePDG)
{
    bool isExist = false;
...
void DST_CC::closeFiles()
{
    cutText.close();
    readme.close();
}

void DST_CC::openFiles(string cutFile, string readmeFile)
{
...
double DST_CC::getPercent(double nAll, double nCurrent)
{
    double percent;
...
double DST_CC::getMomentum( double px, double py, double pz)
{
    double P;
...
double DST_CC::getAngle( double x1, double y1, double z1,
...
double DST_CC::radtodeg(double rad)
{
    double deg;
...
Int_t DST_CC::GetEntry(Long64_t entry)
{
...
Long64_t DST_CC::LoadTree(Long64_t entry)
{
...
void DST_CC::Init(string playlist, TChain* fChain)
{
...
void DST_CC::Show(Long64_t entry)
{
...
Int_t DST_CC::Cut(Long64_t entry)
{
